...
public class MyLinkedListTest {
    ...
    public void shouldContain(){
        ...
        myLinkedList.add(6);
        myLinkedList.add(37);
        Assert.assertTrue(myLinkedList.contains(6));
    }
    ...
    public void shouldNotContain(){
        ...
        myLinkedList.add(6);
        myLinkedList.add(37);
        Assert.assertFalse(myLinkedList.contains(136));
    }

    @Test
    public void shouldBeRemovedIfPresent(){
        Assert.assertTrue(myLinkedList2.remove((Object)33));
    }
    ...
    public void shouldGetValue(){
        Assert.assertEquals((Object) 33,myLinkedList2.get(2));
    }
